...
class MainWindow(tk.Tk):
    ...
    def make(self) -> None:
        ...
        print(f'Create Return: {new_message["return"]}, Type: {type(new_message["return"])}')
    ...
    def create(self, username:str, password:str, confirm:str, initials:str) -> None:
        ...
        print(f'Attempting to create account. Username: ({username}), Password: ({password}), Initials: ({initials})')
        ...
        self.server_socket.send({'request':'create_account', 'username':username, 'password':password, 'initials':initials})
